...
fn main() {
    println!("cargo:rerun-if-env-changed=CASCADE_GHOSTTY_VT_DIR");
    ...
    fs::copy(archive, out.join("libcascade-ghostty-core.a"))
    ...
    run(Command::new("ar")
        .arg("crs")
        .arg(out.join("libcascade-vt-shim.a"))
        .arg(object));
    println!("cargo:rustc-link-search=native={}", out.display());
    println!("cargo:rustc-link-lib=static=cascade-vt-shim");
    println!("cargo:rustc-link-lib=static=cascade-ghostty-core");
