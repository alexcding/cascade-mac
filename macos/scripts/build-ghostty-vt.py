...
def main():
    ...
    (output / "cascade-ghostty-revision").write_text(revision + "\n")
    (output / "cascade-ghostty-query-patch").write_bytes(query_patch.read_bytes())
    (output / "cascade-ghostty-glyph-patch").write_bytes(glyph_patch.read_bytes())
    (output / "cascade-ghostty-graphics-patch").write_bytes(graphics_patch.read_bytes())
